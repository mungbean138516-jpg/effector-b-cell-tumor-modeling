# LEGACY / UNVALIDATED.
#
# This historical script is preserved for provenance only. It clamps negative
# states, does not reproduce the original CIR crossing criterion, and has no
# committed outputs. Use code/post_meeting/sde_validation instead.
